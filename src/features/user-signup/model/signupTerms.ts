...
export const signupTerms: SignupTerm[] = [
  {
    ...
    detail: {
      ...
      version: 'v0.2 · 2026-09-20 시행',
      sections: [
        { heading: '제1조 목적과 적용', content: '이 약관은 머문음 서비스의 이용 조건, 회사와 회원의 권리·의무 및 책임 사항을 정합니다. 서비스에는 지도 기반 음악 기록, 게시·열람, 채팅, 공유 링크, 음악 탐색 및 AI 음악 추천이 포함됩니다.' },
        { heading: '제2조 약관 게시·변경', content: '중요한 변경 또는 회원에게 불리한 변경은 적용 전 별도 안내하고, 필요한 경우 재동의를 받습니다.' },
        { heading: '제3조 계정', content: '회원은 정확한 정보로 계정을 만들고 인증 수단을 관리해야 합니다. 타인 계정 사용, 허위 정보 등록, 서비스 보안 우회와 운영 방해를 해서는 안 됩니다.' },
        { heading: '제4조 콘텐츠와 커뮤니티', content: '회원은 게시할 권한이 있는 콘텐츠만 게시해야 합니다. 타인의 개인정보·현재 위치·사생활을 동의 없이 게시하거나 저작권을 침해해서는 안 됩니다.' },
        { heading: '제5조 지도 기록과 공유 링크', content: '지도 기록의 좌표는 기기의 현재 위치와 구분됩니다. 공유 링크에는 현재 위치나 철회된 콘텐츠를 자동 포함하지 않습니다.' },
        { heading: '제6조 AI 음악 추천', content: 'AI 결과는 참고용이며 정확성·완전성을 보장하지 않습니다. 프로필 또는 이용 이력 기반 맞춤 추천은 별도 선택 동의가 있는 경우에만 제공합니다.' },
        { heading: '제7조 이용 제한·탈퇴', content: '회원은 설정에서 언제든 탈퇴를 요청할 수 있습니다. 법령상 보관 의무가 있는 정보를 제외하고 회사는 지체 없이 삭제 또는 익명화합니다.' },
      ],
    },
  },
  {
    ...
    detail: {
      ...
      version: 'v0.2 · 2026-09-20 시행',
      sections: [
        { heading: '목적', content: '가입 시 수집한 출생연도·성별과 음악 기록·선호를 반영한 맞춤 음악 추천' },
        { heading: '항목', content: '가입 시 수집한 출생연도, 성별, 공개 범위 내 음악 기록·선호·추천 반응' },
        { heading: '보유 기간', content: '동의 철회 또는 회원 탈퇴 시까지' },
        { heading: '거부 권리', content: '동의를 거부해도 가입과 기본 서비스, 일반 음악 추천은 이용할 수 있습니다.' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    detail: {
      ...
      sections: [
        ...
        { heading: '안내', content: '현재 위치는 이 기능 제공을 위해서만 사용하며, 음악 기록이나 공유 링크에 자동 공개되지 않습니다.' },
      ],
    },
  },
  {
    ...
    detail: {
      ...
      version: 'v0.2 · 2026-09-20 시행',
      sections: [
        { heading: '목적', content: '현재 위치를 기준으로 한 장소 탐색 및 위치 기반 기록 기능 제공' },
        { heading: '항목', content: '기기에서 취득한 현재 위치와 수집 시각' },
        { heading: '보유 기간', content: '기능 제공에 필요한 최소 기간' },
        { heading: '거부 권리', content: '거부해도 직접 장소를 선택하여 기록하는 등 기본 서비스는 이용할 수 있습니다.' },
      ],
    },
  },
  {
